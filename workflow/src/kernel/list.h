 ...
 * pos 是 CommConnEntry 中 list 的地址，减去 list 在结构体中的偏移量，
 * 可以得到整个结构体的指针， linux 内核中的原生链表
...
static inline void slist_splice(struct slist_head *list, struct slist_node *at,
                                struct slist_head *head) {
